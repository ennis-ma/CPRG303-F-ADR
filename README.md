...
1. [Native, Web, or Hybrid App](choose-app-framework.md)
2. [UI Framework](choose-ui-framework.md)
3. [Backend Language](choose-backend-lang.md)
4. [Permissions](permission.md)
5. [Data Storage](data-storage.md)
6. [Push Notifications](notification.md)
7. [Data Privacy and Security](privacy.md)
